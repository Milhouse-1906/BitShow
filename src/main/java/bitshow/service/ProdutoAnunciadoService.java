...
public class ProdutoAnunciadoService {
	...
	public List<Produto_Anunciado> buscarProdutosValidos() {
		Specification<Produto_Anunciado> spec = Specification.where(
				ProdutoAnunciadoSpecifications.produtoNaoNulo().and(ProdutoAnunciadoSpecifications.descricaoNaoVazia())
	...
	public Produto_Anunciado atualizarProduto(Long id, Produto_Anunciado produto)
